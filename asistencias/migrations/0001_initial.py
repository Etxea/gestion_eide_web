...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'asistencias_asistencia', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fecha', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 5, 20, 0, 0))),
            ...
            ('contabilizado', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'asistencias', ['Asistencia'])


    def backwards(self, orm):
        # Deleting model 'Asistencia'
        db.delete_table(u'asistencias_asistencia')


    models = {
        u'asistencias.asistencia': {
            ...
            'fecha': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 20, 0, 0)'}),
