...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Factura.borrador'
        db.add_column(u'facturas_factura', 'borrador',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Factura.borrador'
        db.delete_column(u'facturas_factura', 'borrador')
    ...
    models = {
        ...
        u'facturas.factura': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'iva': ('django.db.models.fields.DecimalField', [], {'default': '21', 'max_digits': '2', 'decimal_places': '0', 'blank': 'True'}),
