...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Parte.contabilizado'
        db.add_column(u'horas_parte', 'contabilizado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Parte.contabilizado'
        db.delete_column(u'horas_parte', 'contabilizado')
